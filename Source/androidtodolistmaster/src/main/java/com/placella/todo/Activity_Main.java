...
public class Activity_Main extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        sync.setText("@string/schyncro");
        sync.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(self, "@string/noto", Toast.LENGTH_SHORT).show();
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent intent) {
    	if (requestCode == REQUEST.EDIT && resultCode == RESPONSE.MODIFIED) {
	    	...
	    	if (todo.replace(item)) {
	    		...
	    		new Dialog_Message(self, "@string/fatal").show();
	    	}
    ...
    public boolean onContextItemSelected(MenuItem item) {  
        if(item.getItemId() == R.id.menu_view){
			...
			new Dialog_Confirm(self, "@string/delteconf", new DialogInterface.OnClickListener() {
				@Override
